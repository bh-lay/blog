...
.side-comments-item .cover {
  width: 50px;
}
.side-comments-item .cover img {
  display: block;
  width: 40px;
  height: 40px;
  border-radius: 100%;
...
.side-comments-item .main {
  flex-grow: 1;
  width: 200px;
}
.side-comments-item .main h4 {
  margin: 0;
  padding: 0;
  font-size: 14px;
  font-weight: 500;
...
.side-comments-item:hover {
  background: #fafafa;
  color: inherit;
}
.side-comments-item.router-link-exact-active {
  cursor: default;
}
</style>
<template>
