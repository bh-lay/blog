...
.index-about-backend {
  ...
  .nodeJS-logo {
    ...
    height: 120px;
    margin: 0 auto 1em;
    background: url("./images/nodejs-icon.png");
  }
  .language {
    p {
      color: #80bd01;
...
.index-about-friends {
  ...
  a {
    ...
    margin: auto;
    background: #eee;
    box-shadow: 2px 2px 4px -2px rgba(0, 0, 0, .4), 0 0 10px rgba(0, 0, 0, .2);
    text-align: center;
    transition: .4s;
    &:hover {
...
<template>
<div class="indeCnt">
  <section class="index-aboutme gallayer"
		:style="{
    ...
    <div class="aboutme-body">
      <div class="grid-row">
        <h2>你好！<br/>我是<strong>剧中人</strong></h2>
        <h3>你是谁？</h3>
