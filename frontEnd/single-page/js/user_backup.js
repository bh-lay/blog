...
define(function(require,exports){
  var hex_md5 = require('js/md5'),
      ...
      loginPanel_tpl = ['<div class="l_loginPanel">',
  ...
  LOGIN.prototype.tab = function(type){
    ...
    switch(type){
      case 'github':
        ...
        var newW = window.open('https://github.com/login/oauth/authorize?client_id=150e88277697b41e0702&redirect_uri=http://bh-lay.com/snsLogin/github/');
      break;
      case 'sina':
        index = 1;
      break;
