 ...
 *  
 */
define("public/js/shareList-debug", [ "lib/juicer-debug" ], function(require, exports) {
    ...
    return function(dom, param) {
        var temp = [ '{@each list as it,index}<li><a href="/share/${it.id}" title="${it.title}" lofox="true" target="_self" >', '<img src="${it.cover}" alt="${it.title}" />', "<strong>${it.title}</strong>", "</a></li>{@/each}" ].join("");
        skip = 0;
