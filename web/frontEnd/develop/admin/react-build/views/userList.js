  ...
  var OpusList = React.createClass({displayName: "OpusList",
    render: function() {
      var commentNodes = this.props.list.map(function(opus, index) {
        return (
          React.createElement(Item, {_id: opus._id, id: opus.id, user_group: opus.user_group, email: opus.email, username: opus.username, key: index})
        );
      });
      return (
      ...
      return (
        React.createElement("div", null, 
          React.createElement("div", {className: "col-md-12 custom-mb10"}, 
             React.createElement("a", {className: "btn btn-primary btn-sm custom-lofox", href: "/admin/publish/user", "data-type": "opus"}, "增加用户")
          ), 
