	...
	var temp = ['<div class="indeCnt">',
		'<section class="index-aboutme">',
			...
			'<div class="my-sns-links">',
				'<a target="_blank" href="https://github.com/bh-lay" title="github"><i class="l-icon l-icon-git"></i></a>',
				'<a target="_blank" href="http://www.zhihu.com/people/imju-zhong-ren" title="知乎"><i class="l-icon l-icon-zhihu"></i></a>',
				'<a target="_blank" href="https://dribbble.com/bh_lay" title="dribbble"><i class="l-icon l-icon-dribbble"></i></a>',
			'</div>',
		'</section>',
		...
		'<section class="index-about-links">',
            '<a target="_blank" href="/topic/aboutme/index.html" class="btn focusme">关于剧中人</a>',
            '<a target="_blank" href="/topic/aboutblog/index.html" class="btn">关于小剧客栈</a>',
		'</section>',
	'</div>'].join('');
