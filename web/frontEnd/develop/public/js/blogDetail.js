                ...
                '<div class="side_card">',
                    ...
                    '<div class="content" style="font-size: 24px;">',
                        '<div class="sns-share" data-text="${intro}" data-url="http://bh-lay.com/blog/${id}" data-title="${title}" data-img="${cover}">',
                            '<a href="javascript:void(0)" data-shareto="weibo"><i class="l-icon l-icon-weibo"></i></a>',
                            '<a href="javascript:void(0)" data-shareto="qzone"><i class="l-icon l-icon-qzone"></i></a>',
                            '<a href="javascript:void(0)" data-shareto="qq"><i class="l-icon l-icon-qq"></i></a>',
